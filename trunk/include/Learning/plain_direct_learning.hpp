...
public:
    plain_direct_learning( environment_type        _environment,
...
template < typename ValueType,
           typename Environment,
           typename ActionFunction >
plain_direct_learning<ValueType, Environment, ActionFunction>::plain_direct_learning( Environment       _environment,
...
template < typename ValueType,
           typename Environment,
           typename ActionFunction >
void plain_direct_learning<ValueType, Environment, ActionFunction>::new_episode()
{
...
template < typename ValueType,
           typename Environment,
           typename ActionFunction >
bool plain_direct_learning<ValueType, Environment, ActionFunction>::update()
{
...
template < typename ValueType,
           typename Environment,
           typename ActionFunction >
boost::mt19937 plain_direct_learning<ValueType, Environment, ActionFunction>::rng; 
