#ifndef __WALKER_YARD_CONTROL_CHAIN_LEANING_CONTROL_H__
#define __WALKER_YARD_CONTROL_CHAIN_LEANING_CONTROL_H__
...
public:
    ...
    typedef environment_wrapper<Environment>    rl_environment_type;
...
public:
	...
	vector_function_type&       getActionFunction()         { return vectorFunction; }
...
#endif // __WALKER_YARD_CONTROL_CHAIN_LEANING_CONTROL_H__
