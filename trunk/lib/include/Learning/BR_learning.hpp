#ifndef __WALKER_YARD_BR_LEARNING_HPP___
#define __WALKER_YARD_BR_LEARNING_HPP___
...
private:
    ...
    size_t                      numActions;
    std::deque<std::pair<std::vector<value_type>, value_type> > track;
public:
	int numEpisodes;
};
...
#endif  // __WALKER_YARD_BR_LEARNING_HPP___